...
void      bigIntGetKDACallValue(bigInt destinationHandle);
void      bigIntGetKDAExternalBalance(byte *addressOffset, byte *tokenIDOffset, unsigned int tokenIDLen, long long nonce, bigInt result);
