...
func (ens *EpochNotifierStub) IsKDATransferRoleFlagEnabled() bool {
	return true
}
...
func (ens *EpochNotifierStub) IsMultiKDATransferFixOnCallBackFlagEnabled() bool {
	return true
}
...
func (ens *EpochNotifierStub) IsKDANFTImprovementV1FlagEnabled() bool {
	return true
}

// MultiKDATransferAsyncCallBackEnableEpoch -
func (ens *EpochNotifierStub) MultiKDATransferAsyncCallBackEnableEpoch() uint32 {
	return 0
}
