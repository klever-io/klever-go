...
type OutputContextStub struct {
	...
	TransferKDACalled                 func(transfersArgs *vmhost.KDATransfersArgs, input *vmcommon.ContractCallInput) (uint64, error)
...
func (o *OutputContextStub) Transfer(destination []byte, sender []byte, gasLimit uint64, value *big.Int, input []byte, _ vm.CallType) error {
...
// TransferKDA mocked method
func (o *OutputContextStub) TransferKDA(transfersArgs *vmhost.KDATransfersArgs, callInput *vmcommon.ContractCallInput) (uint64, error) {
	if o.TransferKDACalled != nil {
		return o.TransferKDACalled(transfersArgs, callInput)
	}
	return 0, nil
}
