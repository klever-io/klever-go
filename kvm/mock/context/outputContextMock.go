...
func (o *OutputContextMock) Transfer(_ []byte, _ []byte, _ uint64, _ *big.Int, _ []byte, _ vm.CallType) error {
	return o.TransferResult
}

// TransferKDA mocked method
func (o *OutputContextMock) TransferKDA(_ *vmhost.KDATransfersArgs, _ *vmcommon.ContractCallInput) (uint64, error) {
	return 0, nil
}
