...
// extern int32_t   w2_getKDAValue(void* context, int32_t resultOffset);
// extern int32_t   w2_getKDAValueByIndex(void* context, int32_t resultOffset, int32_t index);
// extern int32_t   w2_getKDATokenName(void* context, int32_t resultOffset);
// extern int32_t   w2_getKDATokenNameByIndex(void* context, int32_t resultOffset, int32_t index);
// extern long long w2_getKDATokenNonce(void* context);
// extern long long w2_getKDATokenNonceByIndex(void* context, int32_t index);
// extern int32_t   w2_getKDATokenType(void* context);
// extern int32_t   w2_getKDATokenTypeByIndex(void* context, int32_t index);
// extern int32_t   w2_getNumKDATransfers(void* context);
// extern int32_t   w2_getCallValueByTokenName(void* context, int32_t callValueOffset, int32_t tokenNameOffset, int32_t tokenNameLength);
...
// extern int32_t   w2_managedMultiTransferKDANFTExecute(void* context, int32_t dstHandle, int32_t tokenTransfersHandle, long long gasLimit, int32_t functionHandle, int32_t argumentsHandle);
...
// extern int32_t   w2_managedAccHasPerm(void* context, long long ops, int32_t sourceAccAddr, int32_t targetAccAddr);
...
// extern void      w2_bigIntGetKDACallValue(void* context, int32_t destination);
// extern void      w2_bigIntGetKDACallValueByIndex(void* context, int32_t destinationHandle, int32_t index);
// extern void      w2_bigIntGetExternalBalance(void* context, int32_t addressOffset, int32_t result);
// extern void      w2_bigIntGetKDAExternalBalance(void* context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce, int32_t resultHandle);
...
func populateCgoFunctionPointers() *cWasmerVmHookPointers {
	return &cWasmerVmHookPointers{
		...
		get_kda_value_func_ptr: funcPointer(C.w2_getKDAValue),
		get_kda_value_by_index_func_ptr: funcPointer(C.w2_getKDAValueByIndex),
		get_kda_token_name_func_ptr: funcPointer(C.w2_getKDATokenName),
		get_kda_token_name_by_index_func_ptr: funcPointer(C.w2_getKDATokenNameByIndex),
		get_kda_token_nonce_func_ptr: funcPointer(C.w2_getKDATokenNonce),
		get_kda_token_nonce_by_index_func_ptr: funcPointer(C.w2_getKDATokenNonceByIndex),
		get_kda_token_type_func_ptr: funcPointer(C.w2_getKDATokenType),
		get_kda_token_type_by_index_func_ptr: funcPointer(C.w2_getKDATokenTypeByIndex),
		get_num_kda_transfers_func_ptr: funcPointer(C.w2_getNumKDATransfers),
		get_call_value_by_token_name_func_ptr: funcPointer(C.w2_getCallValueByTokenName),
		...
		managed_get_kda_token_data_func_ptr: funcPointer(C.w2_managedGetKDATokenData),
		managed_get_kda_roles_func_ptr: funcPointer(C.w2_managedGetKDARoles),
		...
		managed_multi_transfer_kda_nft_execute_func_ptr: funcPointer(C.w2_managedMultiTransferKDANFTExecute),
		...
		managed_acc_has_perm_func_ptr: funcPointer(C.w2_managedAccHasPerm),
		...
		big_int_get_kda_call_value_func_ptr: funcPointer(C.w2_bigIntGetKDACallValue),
		big_int_get_kda_call_value_by_index_func_ptr: funcPointer(C.w2_bigIntGetKDACallValueByIndex),
		big_int_get_external_balance_func_ptr: funcPointer(C.w2_bigIntGetExternalBalance),
		big_int_get_kda_external_balance_func_ptr: funcPointer(C.w2_bigIntGetKDAExternalBalance),
...
//export w2_getKDABalance
func w2_getKDABalance(context unsafe.Pointer, addressOffset int32, tokenIDOffset int32, tokenIDLen int32, nonce int64, resultOffset int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
...
func w2_getKDATokenData(context unsafe.Pointer, addressOffset int32, tokenIDOffset int32, tokenIDLen int32, nonce int64, precisionHandle int32, idOffset int32, nameOffset int32, creatorOffset int32, logoOffset int32, initialSupplyOffset int32, circulatingSupplyOffset int32, maxSupplyOffset int32, mintedOffset int32, burnedOffset int32, royaltiesOffset int32, propertiesOffset int32, attributesOffset int32, rolesOffset int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenData(executor.MemPtr(addressOffset), executor.MemPtr(tokenIDOffset), tokenIDLen, nonce, precisionHandle, executor.MemPtr(idOffset), executor.MemPtr(nameOffset), executor.MemPtr(creatorOffset), executor.MemPtr(logoOffset), executor.MemPtr(initialSupplyOffset), executor.MemPtr(circulatingSupplyOffset), executor.MemPtr(maxSupplyOffset), executor.MemPtr(mintedOffset), executor.MemPtr(burnedOffset), executor.MemPtr(royaltiesOffset), executor.MemPtr(propertiesOffset), executor.MemPtr(attributesOffset), executor.MemPtr(rolesOffset))
}
...
//export w2_getKDAValue
func w2_getKDAValue(context unsafe.Pointer, resultOffset int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDAValue(executor.MemPtr(resultOffset))
}

//export w2_getKDAValueByIndex
func w2_getKDAValueByIndex(context unsafe.Pointer, resultOffset int32, index int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDAValueByIndex(executor.MemPtr(resultOffset), index)
}

//export w2_getKDATokenName
func w2_getKDATokenName(context unsafe.Pointer, resultOffset int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenName(executor.MemPtr(resultOffset))
}

//export w2_getKDATokenNameByIndex
func w2_getKDATokenNameByIndex(context unsafe.Pointer, resultOffset int32, index int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenNameByIndex(executor.MemPtr(resultOffset), index)
}

//export w2_getKDATokenNonce
func w2_getKDATokenNonce(context unsafe.Pointer) int64 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenNonce()
}

//export w2_getKDATokenNonceByIndex
func w2_getKDATokenNonceByIndex(context unsafe.Pointer, index int32) int64 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenNonceByIndex(index)
}

//export w2_getKDATokenType
func w2_getKDATokenType(context unsafe.Pointer) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenType()
}

//export w2_getKDATokenTypeByIndex
func w2_getKDATokenTypeByIndex(context unsafe.Pointer, index int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetKDATokenTypeByIndex(index)
}

//export w2_getNumKDATransfers
func w2_getNumKDATransfers(context unsafe.Pointer) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetNumKDATransfers()
}

//export w2_getCallValueByTokenName
func w2_getCallValueByTokenName(context unsafe.Pointer, callValueOffset int32, tokenNameOffset int32, tokenNameLength int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.GetCallValueByTokenName(executor.MemPtr(callValueOffset), executor.MemPtr(tokenNameOffset), tokenNameLength)
}
...
//export w2_managedGetKDACallValue
func w2_managedGetKDACallValue(context unsafe.Pointer, kdaCallValueHandle int32, kdaHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.ManagedGetKDACallValue(kdaCallValueHandle, kdaHandle)
}

//export w2_managedGetMultiKDACallValue
...
func w2_managedGetBackTransfers(context unsafe.Pointer, kdaTransfersValueHandle int32, callValueHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.ManagedGetBackTransfers(kdaTransfersValueHandle, callValueHandle)
}

//export w2_managedGetKDABalance
func w2_managedGetKDABalance(context unsafe.Pointer, addressHandle int32, tokenIDHandle int32, nonce int64, valueHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.ManagedGetKDABalance(addressHandle, tokenIDHandle, nonce, valueHandle)
}

//export w2_managedGetUserKDA
func w2_managedGetUserKDA(context unsafe.Pointer, addressHandle int32, tickerHandle int32, nonce int64, balanceHandle int32, frozenHandle int32, lastClaimHandle int32, bucketsHandle int32, mimeHandle int32, metadataHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.ManagedGetUserKDA(addressHandle, tickerHandle, nonce, balanceHandle, frozenHandle, lastClaimHandle, bucketsHandle, mimeHandle, metadataHandle)
}
...
func w2_managedGetKDARoles(context unsafe.Pointer, tickerHandle int32, rolesHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.ManagedGetKDARoles(tickerHandle, rolesHandle)
}
...
//export w2_managedMultiTransferKDANFTExecute
func w2_managedMultiTransferKDANFTExecute(context unsafe.Pointer, dstHandle int32, tokenTransfersHandle int32, gasLimit int64, functionHandle int32, argumentsHandle int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.ManagedMultiTransferKDANFTExecute(dstHandle, tokenTransfersHandle, gasLimit, functionHandle, argumentsHandle)
}
...
//export w2_managedAccHasPerm
func w2_managedAccHasPerm(context unsafe.Pointer, ops int64, sourceAccAddr int32, targetAccAddr int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.ManagedAccHasPerm(ops, sourceAccAddr, targetAccAddr)
}
...
//export w2_bigIntGetKDACallValue
func w2_bigIntGetKDACallValue(context unsafe.Pointer, destination int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.BigIntGetKDACallValue(destination)
}

//export w2_bigIntGetKDACallValueByIndex
func w2_bigIntGetKDACallValueByIndex(context unsafe.Pointer, destinationHandle int32, index int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.BigIntGetKDACallValueByIndex(destinationHandle, index)
}
...
//export w2_bigIntGetKDAExternalBalance
func w2_bigIntGetKDAExternalBalance(context unsafe.Pointer, addressOffset int32, tokenIDOffset int32, tokenIDLen int32, nonce int64, resultHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.BigIntGetKDAExternalBalance(executor.MemPtr(addressOffset), executor.MemPtr(tokenIDOffset), tokenIDLen, nonce, resultHandle)
}
