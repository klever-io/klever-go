...
type MainVMHooks interface {
	...
	GetKDAValue(resultOffset MemPtr) int32
	GetKDAValueByIndex(resultOffset MemPtr, index int32) int32
	GetKDATokenName(resultOffset MemPtr) int32
	GetKDATokenNameByIndex(resultOffset MemPtr, index int32) int32
	GetKDATokenNonce() int64
	GetKDATokenNonceByIndex(index int32) int64
	GetKDATokenType() int32
	GetKDATokenTypeByIndex(index int32) int32
	GetNumKDATransfers() int32
	GetCallValueByTokenName(callValueOffset MemPtr, tokenNameOffset MemPtr, tokenNameLength MemLength) int32
...
type ManagedVMHooks interface {
	...
	ManagedMultiTransferKDANFTExecute(dstHandle int32, tokenTransfersHandle int32, gasLimit int64, functionHandle int32, argumentsHandle int32) int32
...
type BigIntVMHooks interface {
	...
	BigIntGetKDACallValue(destination int32)
	BigIntGetKDACallValueByIndex(destinationHandle int32, index int32)
	BigIntGetExternalBalance(addressOffset MemPtr, result int32)
	BigIntGetKDAExternalBalance(addressOffset MemPtr, tokenIDOffset MemPtr, tokenIDLen MemLength, nonce int64, resultHandle int32)
