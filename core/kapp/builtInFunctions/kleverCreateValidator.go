...
func (e *kleverCreateValidator) ProcessBuiltinFunction(vmInput *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	err = e.payableHandler.CheckPayable(vmInput, vmInput.RecipientAddr, core.MinLenArgumentsCreateValidator)
	if err != nil {
		return nil, err
	}
...
func (e *kleverCreateValidator) SetPayableChecker(payableHandler vmcommon.PayableChecker) error {
