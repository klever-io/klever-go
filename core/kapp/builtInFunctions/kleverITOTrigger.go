...
func (e *kleverITOTrigger) ProcessBuiltinFunction(vmInput *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	//err = e.payableHandler.CheckPayable(vmInput, vmInput.RecipientAddr, core.MinLenArgumentsITOTrigger)
	//if err != nil {
	//	return nil, err
	//}
...
func (e *kleverITOTrigger) SetPayableChecker(payableHandler vmcommon.PayableChecker) error {
