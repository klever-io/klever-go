...
func (e *kleverValidatorConfig) ProcessBuiltinFunction(vmInput *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	err = e.payableHandler.CheckPayable(vmInput, vmInput.RecipientAddr, core.MinLenArgumentsValidatorConfig)
	if err != nil {
		return nil, err
	}
...
func (e *kleverValidatorConfig) SetPayableChecker(payableHandler vmcommon.PayableChecker) error {
