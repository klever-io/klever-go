...
func (e *kleverProposal) ProcessBuiltinFunction(vmInput *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	err = e.payableHandler.CheckPayable(vmInput, vmInput.RecipientAddr, core.MinLenArgumentsProposal)
	if err != nil {
		return nil, err
	}
...
func (e *kleverProposal) SetPayableChecker(payableHandler vmcommon.PayableChecker) error {
