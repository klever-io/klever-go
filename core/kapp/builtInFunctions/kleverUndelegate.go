...
func (e *kleverUndelegate) ProcessBuiltinFunction(vmInput *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	//err = e.payableHandler.CheckPayable(vmInput, vmInput.RecipientAddr, core.MinLenArgumentsUndelegate)
	//if err != nil {
	//	return nil, err
	//}
...
func (e *kleverUndelegate) SetPayableChecker(payableHandler vmcommon.PayableChecker) error {
