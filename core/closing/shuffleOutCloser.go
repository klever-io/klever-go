...
func NewShuffleOutCloser(
	...
	if minWaitDuration < minDuration {
		return nil, fmt.Errorf("%w for minWaitDuration", common.ErrInvalidValue)
	}
	if maxWaitDuration < minDuration {
		return nil, fmt.Errorf("%w for maxWaitDuration", common.ErrInvalidValue)
	}
	if minWaitDuration > maxWaitDuration {
		return nil, fmt.Errorf("%w, minWaitDuration > maxWaitDuration", common.ErrInvalidValue)
	}
	if signalChan == nil {
		return nil, common.ErrNilSignalChan
	}
