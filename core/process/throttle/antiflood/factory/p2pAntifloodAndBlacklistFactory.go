...
import (
	...
	"github.com/klever-io/klever-go/core/process/throttle/antiflood"
	"github.com/klever-io/klever-go/core/process/throttle/antiflood/blackList"
	"github.com/klever-io/klever-go/core/process/throttle/antiflood/disabled"
	"github.com/klever-io/klever-go/core/process/throttle/antiflood/floodPreventers"
	"github.com/klever-io/klever-go/network/p2p"
	"github.com/klever-io/klever-go/statusHandler/p2pQuota"
...
func createFloodPreventer(
	...
	blackListProcessor, err := blackList.NewP2PBlackListProcessor(
		...
		floodPreventerConfig.BlackList.NumFloodingSlots,
	...
	log.Debug("started antiflood & blacklist component",
		...
		"peerMaxTotalSizePerInterval", tools.ConvertBytes(peerMaxTotalSizePerInterval),
		...
		"numFloodingSlots", floodPreventerConfig.BlackList.NumFloodingSlots,
