...
// IsOriginatorElectedForTopic returns error if pid is not allowed to send messages on topic
func (af *p2pAntiflood) IsOriginatorElectedForTopic(pid core.PeerID, topic string) error {
