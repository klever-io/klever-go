...
type SposWorkerMock struct {
	...
	GetBroadcastBlockCalled                func(data.HeaderHandler, data.HeaderHandler) error
...
// BroadcastBlock -
func (sposWorkerMock *SposWorkerMock) BroadcastBlock(body data.HeaderHandler, header data.HeaderHandler) error {
