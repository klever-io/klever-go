...
func (cc *ConsensusCore) SlotManager() consensus.SlotManager {
	return cc.slotManager
}
...
func (cc *ConsensusCore) EpochStartRegistrationHandler() eventNotifier.RegistrationHandler {
