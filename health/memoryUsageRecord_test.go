...
func TestMemoryUsageRecord_GetFilename(t *testing.T) {
	...
	record := newMemoryUsageRecord(runtime.MemStats{HeapInuse: 42 * tools.MegabyteSize}, timestamp, ".")
...
func TestMemoryUsageRecord_SaveThenDelete(t *testing.T) {
	record := newMemoryUsageRecord(runtime.MemStats{HeapInuse: 42 * tools.MegabyteSize}, time.Now(), ".")
