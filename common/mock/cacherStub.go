...
type CacherStub struct {
	...
	PendingForCalled        func(accountKey []byte) (uint64, uint64)
...
// PendingFor -
func (cacher *CacherStub) PendingFor(accountKey []byte) (uint64, uint64) {
	return cacher.PendingForCalled(accountKey)
}
