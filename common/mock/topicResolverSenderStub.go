...
type TopicResolverSenderStub struct {
	SendOnRequestTopicCalled func(rd *retriever.RequestData, originalHashes [][]byte) error
	SendCalled               func(buff []byte, peer core.PeerID) error
	SetNumPeersToQueryCalled func(intra int, cross int)
	GetNumPeersToQueryCalled func() (int, int)
	debugHandler             retriever.ResolverDebugHandler
}
...
// SendOnRequestTopic -
func (trss *TopicResolverSenderStub) SendOnRequestTopic(rd *retriever.RequestData, originalHashes [][]byte) error {
...
func (trss *TopicResolverSenderStub) SendOnRequestTopicTo(rd *retriever.RequestData, originalHashes [][]byte, _ core.PeerID) error {
	return trss.SendOnRequestTopic(rd, originalHashes)
}
...
func (trss *TopicResolverSenderStub) ResolverDebugHandler() retriever.ResolverDebugHandler {
...
func (trss *TopicResolverSenderStub) SetResolverDebugHandler(handler retriever.ResolverDebugHandler) error {
