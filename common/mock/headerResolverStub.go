...
// SetEpochHandler -
func (hrs *HeaderResolverStub) SetEpochHandler(epochHandler retriever.EpochHandler) error {
...
func (hrs *HeaderResolverStub) SetResolverDebugHandler(handler retriever.ResolverDebugHandler) error {
