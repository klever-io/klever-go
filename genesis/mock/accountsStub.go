...
type AccountsStub struct {
	AddJournalEntryCalled    func(je state.JournalAccountEntry)
...
var errAccNotImplemented = errors.New("acc not implemented")

// AddJournalEntry -
func (as *AccountsStub) AddJournalEntry(je state.JournalAccountEntry) {
