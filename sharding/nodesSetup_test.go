...
func initNodesConfig(ns *NodesSetup, noOfInitialNodes int) bool {
	...
	for i := 0; i < noOfInitialNodes; i++ {
		...
		ns.InitialNodes[i].elected = uint32(i) < ns.MinNodes
	}
...
func createAndAssignNodes(ns NodesSetup, noOfInitialNodes int) *NodesSetup {
	...
	for i := 0; i < noOfInitialNodes; i++ {
		...
		ns.InitialNodes[i].elected = i < noOfInitialNodes
	}
...
func createNodesSetupTwoNodes() *NodesSetup {
	noOfInitialNodes := 2
	ns := &NodesSetup{
...
func TestNodesSetup_InitialNodesPubKeysFromNil(t *testing.T) {
	...
	ns := NodesSetup{
		elected: make([]GenesisNodeInfoHandler, 0),
	}
	elected, eligible, err := ns.InitialNodesInfo()
	assert.Equal(t, err, ErrNilElected)
	assert.NotNil(t, ns)
...
func TestNodesSetup_ProcessConfigInvalidConsensusGroupSizeLargerThanNumOfNodesShouldErr(t *testing.T) {
	...
	assert.NotNil(t, ns)
	assert.Equal(t, ErrMinNodesSmallerThanConsensusSize, err)
}

func TestNodesSetup_ProcessConfigInvalidMinNodesShouldErr(t *testing.T) {
	t.Parallel()
...
func TestNodesSetup_ProcessConfigInvalidMetaMinNodesShouldErr(t *testing.T) {
	t.Parallel()
...
func TestNodesSetup_ProcessConfigInvalidNumOfNodesSmallerThanMinNodesShouldErr(t *testing.T) {
	t.Parallel()
...
func TestNodesSetup_ProcessConfigInvalidMetaNumOfNodesSmallerThanMinNodesShouldErr(t *testing.T) {
	t.Parallel()
...
func TestNodesSetup_InitialNodesPubKeysNil(t *testing.T) {
	t.Parallel()
...
func TestNodesSetup_InitialNodesPubKeysGood(t *testing.T) {
	t.Parallel()

	ns := createNodesSetupTwoNodes()
	elected, eligible, err := ns.InitialNodesInfo()

	assert.NotNil(t, ns)
	assert.Equal(t, 2, len(elected))
...
func TestNodesSetup_MinNumberOfNodes(t *testing.T) {
	...
	assert.Equal(t, uint32(400), minNumNodes)
}
