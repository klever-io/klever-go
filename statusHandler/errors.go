...
// ErrNilConnectorStartChannel signals that a nil Connector start channel has been provided
var ErrNilConnectorStartChannel = errors.New("nil Connector start channel")
