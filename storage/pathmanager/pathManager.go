...
func NewPathManager(pruningPathTemplate string, staticPathTemplate string, databasePath string) (*PathManager, error) {
	...
	if !strings.Contains(staticPathTemplate, core.PathIdentifierPlaceholder) {
...
func (pm *PathManager) PathForEpoch(epoch uint32, identifier string) string {
...
func (pm *PathManager) PathForStatic(identifier string) string {
