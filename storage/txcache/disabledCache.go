...
func (cache *DisabledCache) SelectTransactions(_ int, _ int, _ uint64) []*WrappedTransaction {
	return make([]*WrappedTransaction, 0)
}

// RemoveTxByHash does nothing
func (cache *DisabledCache) RemoveTxByHash(_ []byte) (*WrappedTransaction, bool) {
	return nil, false
}
...
func (cache *DisabledCache) RemoveTxBySenderNonce(sender []byte, nonce uint64) int {
	return 0
}

func (cache *DisabledCache) GetBySenderPaginated(sender []byte, page int, pageSize int) ([]interface{}, int) {
