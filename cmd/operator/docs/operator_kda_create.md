...
```
      --addRolesDeposit strings                   KDA addRolesDeposit
      --addRolesMint strings                      KDA addRolesMint
      --addRolesSetITOPrices strings              KDA addRolesSetITOPrices
      --addRolesTransfer strings                  KDA addRolesTransfer
      --adminAddress string                       KDA adminAddress
      --apr float                                 KDA apr
  ...
  -h, --help                                      help for create
      ...
      --limitTransfer                             KDA limitTransfer
