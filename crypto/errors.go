...
// ErrNilTXKeyGen signals that a nil transaction key generator has been provided
var ErrNilTXKeyGen = errors.New("trying to set nil tx key generator")

// ErrInvalidSignerAction signals invalid call
var ErrInvalidSignerAction = errors.New("invalid signer lib call")
