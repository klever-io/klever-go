...
// CreatePointFromBytes returns a newly created public key which is a point on ed25519 from bytes
func (s *suiteEd25519) CreatePointFromBytes(b []byte) (crypto.Point, error) {
	publicKey := &ed25519Point{b}
